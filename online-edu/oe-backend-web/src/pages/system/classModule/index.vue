  ...
  <t-card>
    <t-form layout="inline" :data="queryForm" :label-width="50" colon @submit="onSubmit">
      ...
      <t-form-item label="类型" name="classType">
        <t-select v-model="queryForm.classType" :style="{ width: '200px' }" clearable>
...
import ClassModuleForm from './components/ClassModuleForm.vue';
...
const typeMap = dictStore.getDictItem('CLASS_TYPE');
