...
import CustomerGradeForm from './components/CustomerGradeForm.vue';
...
const fetchData = async () => {
  ...
  try {
    const { content, totalItems } = await customerGradeMgt.page(queryForm.value);
    data.value = content;
...
const handleBatchDelete = async () => {
  ...
  await customerGradeMgt.batchDel(selectedRowKeys.value);
  await fetchData();
  MessagePlugin.success('删除成功');
