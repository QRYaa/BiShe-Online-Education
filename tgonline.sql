...
INSERT INTO `bs_user` VALUES (1,'','',1,0,'$2a$10$OsB/wLTsPDyC/ysBROGTGuPo.fDsSSrQOQQv.E3oQ2kjOQQM2pSOy','admin',1,_binary '\0','000','','管理员',NULL,NULL,1,'2024-07-30 14:31:45.865000',NULL),(6,'',NULL,1,1,'$2a$10$MEWngukmYw9.WyidoPgSXe6fHDx7GIhMla/jnCf1ESiJ5wlGw1oqa','noside',2,_binary '\0','0001','','普通员工',NULL,NULL,1,'2024-12-05 17:36:10.064000',NULL),(31,NULL,NULL,1,NULL,'$2a$10$PAU1ttOo7OtC03727Pr/8uqiYIlQRJRn6i4NADP6gh336vIU/rfXe','qry',2,NULL,NULL,'','邱如意',1,'2024-12-06 09:51:53.254000',1,'2024-12-06 09:51:53.254000',NULL),(32,'',NULL,1,1,NULL,'QiuRuYiCeShi',2,_binary '\0',NULL,'','邱如意测试',NULL,NULL,1,'2024-12-09 14:17:26.780000',NULL);
...
LOCK TABLES `oe_chapter` WRITE;
/*!40000 ALTER TABLE `oe_chapter` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_chapter` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `oe_course_type`
--

LOCK TABLES `oe_course_type` WRITE;
/*!40000 ALTER TABLE `oe_course_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_course_type` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `oe_lesson` (
  ...
  `preview_able` bit(1) DEFAULT NULL,
...
--
-- Dumping data for table `oe_lesson`
--

LOCK TABLES `oe_lesson` WRITE;
/*!40000 ALTER TABLE `oe_lesson` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_lesson` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `oe_member` (
  ...
  `real_name_authenticated` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `oe_member`
--

LOCK TABLES `oe_member` WRITE;
/*!40000 ALTER TABLE `oe_member` DISABLE KEYS */;
INSERT INTO `oe_member` VALUES (1,'/img/2025/3/5/64791a1b-497b-43e4-9fb5-359f572c87cf.png',NULL,'202503190029',1,NULL,'默认用户0303',NULL,'2025-03-04 00:00:00.000000',NULL,NULL,'o0Hls6xF6DDuPiBMRGXvXB4pHBko',NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `oe_member` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `oe_member_auth_token`
--

LOCK TABLES `oe_member_auth_token` WRITE;
/*!40000 ALTER TABLE `oe_member_auth_token` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_auth_token` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_member_collect_course`
--

DROP TABLE IF EXISTS `oe_member_collect_course`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_member_collect_course` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `course_id` bigint DEFAULT NULL,
  `member_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `oe_member_collect_course`
--

LOCK TABLES `oe_member_collect_course` WRITE;
/*!40000 ALTER TABLE `oe_member_collect_course` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_collect_course` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `oe_member_course`
--

LOCK TABLES `oe_member_course` WRITE;
/*!40000 ALTER TABLE `oe_member_course` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_course` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_member_id_card`
--

DROP TABLE IF EXISTS `oe_member_id_card`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_member_id_card` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `oe_member_id_card`
--

LOCK TABLES `oe_member_id_card` WRITE;
/*!40000 ALTER TABLE `oe_member_id_card` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_id_card` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_member_id_card_audit`
--

DROP TABLE IF EXISTS `oe_member_id_card_audit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_member_id_card_audit` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `audit_time` datetime(6) DEFAULT NULL,
  `auditor_id` bigint DEFAULT NULL,
  `create_time` datetime(6) DEFAULT NULL,
  `id_card_address` varchar(200) DEFAULT NULL,
  `id_card_back_image_url` varchar(255) DEFAULT NULL,
  `id_card_birthday` datetime(6) DEFAULT NULL,
  `id_card_expire_date` datetime(6) DEFAULT NULL,
  `id_card_front_image_url` varchar(255) DEFAULT NULL,
  `id_card_gender` int DEFAULT NULL,
  `id_card_issue_date` datetime(6) DEFAULT NULL,
  `id_card_number` varchar(18) DEFAULT NULL,
  `id_card_real_name` varchar(50) DEFAULT NULL,
  `id_card_type` int DEFAULT NULL,
  `member_id` bigint NOT NULL,
...
--
-- Dumping data for table `oe_member_id_card_audit`
--

LOCK TABLES `oe_member_id_card_audit` WRITE;
/*!40000 ALTER TABLE `oe_member_id_card_audit` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_id_card_audit` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `oe_member_lesson`
--

LOCK TABLES `oe_member_lesson` WRITE;
/*!40000 ALTER TABLE `oe_member_lesson` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_lesson` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_member_like_note`
--

DROP TABLE IF EXISTS `oe_member_like_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_member_like_note` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `lesson_id` bigint DEFAULT NULL,
  `member_id` bigint DEFAULT NULL,
...
--
-- Dumping data for table `oe_member_like_note`
--

LOCK TABLES `oe_member_like_note` WRITE;
/*!40000 ALTER TABLE `oe_member_like_note` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_like_note` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_member_like_reply`
--

DROP TABLE IF EXISTS `oe_member_like_reply`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_member_like_reply` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `member_id` bigint DEFAULT NULL,
  `note_id` bigint DEFAULT NULL,
...
--
-- Dumping data for table `oe_member_like_reply`
--

LOCK TABLES `oe_member_like_reply` WRITE;
/*!40000 ALTER TABLE `oe_member_like_reply` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_member_like_reply` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `oe_news` WRITE;
/*!40000 ALTER TABLE `oe_news` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_news` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_note`
--

DROP TABLE IF EXISTS `oe_note`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_note` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `content` text,
  `create_time` datetime(6) DEFAULT NULL,
...
--
-- Dumping data for table `oe_note`
--

LOCK TABLES `oe_note` WRITE;
/*!40000 ALTER TABLE `oe_note` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_note` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `oe_order` (
  ...
  `final_price` decimal(13,2) DEFAULT NULL,
  `member_id` bigint DEFAULT NULL,
...
--
-- Dumping data for table `oe_order`
--

LOCK TABLES `oe_order` WRITE;
/*!40000 ALTER TABLE `oe_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_order` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `oe_order_item`
--

LOCK TABLES `oe_order_item` WRITE;
/*!40000 ALTER TABLE `oe_order_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_order_item` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_reply`
--

DROP TABLE IF EXISTS `oe_reply`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_reply` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `content` varchar(255) DEFAULT NULL,
  `create_time` datetime(6) DEFAULT NULL,
  `enable` bit(1) DEFAULT NULL,
...
--
-- Dumping data for table `oe_reply`
--

LOCK TABLES `oe_reply` WRITE;
/*!40000 ALTER TABLE `oe_reply` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_reply` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_sensitive_word`
--

DROP TABLE IF EXISTS `oe_sensitive_word`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_sensitive_word` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `create_time` datetime(6) DEFAULT NULL,
...
--
-- Dumping data for table `oe_sensitive_word`
--

LOCK TABLES `oe_sensitive_word` WRITE;
/*!40000 ALTER TABLE `oe_sensitive_word` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_sensitive_word` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_teacher`
--

DROP TABLE IF EXISTS `oe_teacher`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_teacher` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `avatar` varchar(255) DEFAULT NULL,
  `code` varchar(255) DEFAULT NULL,
  `content` text,
...
--
-- Dumping data for table `oe_teacher`
--

LOCK TABLES `oe_teacher` WRITE;
/*!40000 ALTER TABLE `oe_teacher` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_teacher` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_teacher_tag`
--

DROP TABLE IF EXISTS `oe_teacher_tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_teacher_tag` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `description` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `oe_teacher_tag`
--

LOCK TABLES `oe_teacher_tag` WRITE;
/*!40000 ALTER TABLE `oe_teacher_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_teacher_tag` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `oe_teacher_tag_map`
--

DROP TABLE IF EXISTS `oe_teacher_tag_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oe_teacher_tag_map` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `oe_teacher_tag_map`
--

LOCK TABLES `oe_teacher_tag_map` WRITE;
/*!40000 ALTER TABLE `oe_teacher_tag_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `oe_teacher_tag_map` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-04-28 23:19:37
